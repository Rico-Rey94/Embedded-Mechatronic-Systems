...
void setup() {
 delay(2000);
 Serial.println("\n\n\n\n"); // Simulate clearing by adding blank lines
 Serial.begin(115200);
 ...
 Serial.println("Step 3: Closed-Loop Speed Control Started");
...
void updateRPM() {
 ...
 // Smooth the RPM a little
 filteredRPM = RPM_FILTER_ALPHA * filteredRPM + (1.0 - RPM_FILTER_ALPHA)
* measuredRPM;
}
void updatePID() {
...
void applyControl() {
 // Add a small feedforward bias so the motor can overcome static friction
 int basePWM = 100;
